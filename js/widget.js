!(function (t) {
    ...
    function y(t, e, n, o, r) {
      ...
      if (0 !== v)
        for (var _ = 0; v > _; _++) {
          ...
          null != j
            ? (m++, (h[j] = O))
            : (C || (void 0 !== O.splitText ? !r || O.nodeValue.trim() : r)) &&
              (d[y++] = O);
        }
      if (0 !== x)
        for (var _ = 0; x > _; _++) {
    ...
    function k(t, e, n, o, r) {
      t._disable ||
        ...
        !t.base || r
          ...
          : t.componentWillReceiveProps && t.componentWillReceiveProps(e, o),
        o &&
          o !== t.context &&
        ...
        if (
          (m &&
            ...
            !1 === t.shouldComponentUpdate(c, u, f)
              ? (_ = !0)
              : t.componentWillUpdate && t.componentWillUpdate(c, u, f),
            (t.props = c),
            (t.state = u),
            (t.context = f)),
          ...
          if ("function" == typeof E) {
            ...
            (s = y),
              ...
              (y || 1 === e) &&
                (s && (s._component = null),
                (j = v(s, r, f, n || !m, y && y.parentNode, !0)));
          if (y && j !== y && a !== x) {
            var A = y.parentNode;
            A &&
              j !== A &&
              (A.replaceChild(j, y), O || ((y._component = null), w(y, !1)));
          }
  ...
  function (t) {
    ...
    t.exports = function (t, e, n, o, r) {
      return (
        (t.config = e), n && (t.code = n), (t.request = o), (t.response = r), t
      );
    };
  },
  function (t, e, n) {
    ...
    t.exports = function (t) {
      return (
        ...
        (t.adapter || s.adapter)(t).then(
          function (e) {
            return (
              o(t), (e.data = i(e.data, e.headers, t.transformResponse)), e
            );
          },
          function (e) {
            return (
